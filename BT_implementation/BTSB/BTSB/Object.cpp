...
void Transform::UpdateModelMatrix()
{
	...
	model_matrix = glm::rotate(model_matrix, GetRotation().x, glm::vec3(1.f, 0.f, 0.f));
	model_matrix = glm::rotate(model_matrix, GetRotation().y, glm::vec3(0.f, 1.f, 0.f));
	model_matrix = glm::rotate(model_matrix, GetRotation().z, glm::vec3(0.f, 0.f, 1.f));
